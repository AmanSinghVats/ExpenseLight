...
const FirstPage = () => {
  ...
  const handleGetStarted = () => {
    window.location.href = ""; // External link to Vercel page
  };
    ...
    <div className="landing-page">
      ...
      <header className="landing-header">
        <nav className="navbar">
          <h1 className="brand-logo">ExpenseLight >>> Your Finances Simplified !!</h1>
      ...
      <main className="hero-section">
        <div className="hero-content">
          <h1 className="hero-title"><b>Seamless Finance Tracking!</b></h1>
          <p className="hero-description">
            Take control of your finances and make smart decisions with our easy-to-use ExpenseLight. Keep track of your income, spending, and savings all in one place.
          </p>
      ...
      <section className="about-section" id="about">
        ...
        <p>
          At ExpenseLight, we believe in simplifying financial management for everyone. Our platform helps you organize your financial life, making it easy to monitor your spending and saving habits.
        </p>
      </section>
      ...
      <footer className="footer" id="contact">
        <div className="footer-content">
          ...
          <p>Email: amankumarsingh130903@gmail.com</p>
          <p>Phone: +91 7007031225</p>
